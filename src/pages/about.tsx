    ...
    <section className="min-h-screen bg-gradient-to-br from-purple-600 to-blue-500 flex items-center justify-center">
      <div className="max-w-4xl text-center p-8 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg">
        ...
        <p className="text-xl text-white leading-relaxed">
          Welcome to Minimalist Tech. I’m <strong>Florian Mealing</strong>, a
          developer driven by the belief that simplicity in design leads to
        ...
        <p className="text-xl text-white leading-relaxed mt-4">
          ...
          make life easier. Over time, I realized that the beauty of technology
        ...
        <p className="text-xl text-white leading-relaxed mt-4">
          ...
          something far more impactful. Along the way, I've learned, grown, and
          sharpened my skills as a developer. What you see today is a reflection
          of my dedication to continuous improvement and a commitment to
